...
* The following dependencies are not known to work with Spring Native: 'Rest Repositories, Apache Freemarker, Spring Web
  Services, Spring Boot DevTools'. As a result, your application may not work as expected.
...
```
$ docker run --rm -p 8080:8080 Course:0.0.1-SNAPSHOT
```
